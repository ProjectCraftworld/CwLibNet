...
public struct ResourceType
{
    public static readonly ResourceType
        ...
        Filename = new(null, 10, "text/", ".txt"), // Could be anything really, but generally will refer to either FSB or BIK
        ...
        Translation = new(null, 30, "translations/", ".trans"),
