namespace CwLibNet.External
{
    public sealed class DDSReader
    {
        ...
        private static int[] DecodeDXT3(int width, int height, int offset, byte[]? buffer, Order order)
        {
            ...
            for (int i = 0; i < h; i++)
            {
                for (int j = 0; j < w; j++)
                {
                    ...
                    int c1 = buffer[index] & 0xFF | (buffer[index + 1] & 0xFF) << 8;
                    index += 2;
                    for (int m = 0; m < 4 && 4 * i + m < height; m++)
                    {
                        int t0 = buffer[index] & 0x3;
                        int t1 = (buffer[index] & 0xC) >> 2;
                        int t2 = (buffer[index] & 0x30) >> 4;
        ...
        private static readonly int[] A1R5G5B5_MASKS = new int[]
        {
            31744,
            992,
            31,
        ...
        private static readonly int[] X1R5G5B5_MASKS = new int[]
        {
            31744,
            992,
            31,
        ...
        private static readonly int[] A4R4G4B4_MASKS = new int[]
        {
            3840,
            240,
            15,
        ...
        private static readonly int[] X4R4G4B4_MASKS = new int[]
        {
            3840,
            240,
            15,
        ...
        private static readonly int[] R5G6B5_MASKS = new int[]
        {
            63488,
            2016,
            31,
        ...
        private static readonly int[] R8G8B8_MASKS = new int[]
        {
            16711680,
            65280,
            255,
        ...
        private static readonly int[] A8B8G8R8_MASKS = new int[]
        {
            255,
            65280,
            16711680,
        ...
        private static readonly int[] X8B8G8R8_MASKS = new int[]
        {
            255,
            65280,
            16711680,
        ...
        private static readonly int[] A8R8G8B8_MASKS = new int[]
        {
            16711680,
            65280,
            255,
        ...
        private static readonly int[] X8R8G8B8_MASKS = new int[]
        {
            16711680,
            65280,
            255,
        ...
        private static readonly int[] BIT5 = new int[]
        {
            0,
            8,
            16,
        ...
        private static readonly int[] BIT6 = new int[]
        {
            0,
            4,
            8,
